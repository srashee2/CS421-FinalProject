...
myStartupHook = do
    ...
    spawnOnce "feh --randomize --bg-scale --no-fehbg ~/Pictures/*"  -- feh set random wallpaper
    setWMName "LG3D"
...
--        , ("M-S-<Up>", sendMessage (IncMasterN 1))      -- Increase # of clients master pane
  --      , ("M-S-<Down>", sendMessage (IncMasterN (-1))) -- Decrease # of clients master pane
    ...
    -- Window resizing
        , ("M-S-<Down>", sendMessage Shrink)                   -- Shrink horiz window width
        , ("M-S-<Up>", sendMessage Expand)                   -- Expand horiz window width
